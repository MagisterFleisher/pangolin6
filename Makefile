...
SRCDIR += 			src/
INCLUDEDIR += 		include/
LINKDIR += 			-L/usr/include/ -Iinclude/ -L/usr/include/c++/11/ -I/usr/include/eigen3/
ALLFILES +=			$(SRCDIR)main.cpp $(INCLUDEDIR)Types.hpp 	$(INCLUDEDIR)GraphProperties.hpp	$(INCLUDEDIR)ReadFile.hpp	$(INCLUDEDIR)CheckFile.hpp	$(INCLUDEDIR)SimplifyGraph.hpp	$(INCLUDEDIR)DegreeCentrality.hpp	$(INCLUDEDIR)GenAlters.hpp	$(INCLUDEDIR)PrestigeSimple.hpp	$(INCLUDEDIR)AdjacencyMatrix.hpp 	$(INCLUDEDIR)DisconnectedSubgraphs.hpp 	# $(INCLUDEDIR)EigenLibraryTest.hpp	$(INCLUDEDIR)GenNodelist.hpp	$(INCLUDEDIR)TriadGen.hpp	$(INCLUDEDIR)GenCliques.hpp $(INCLUDEDIR)GenEdgemap.hpp	$(INCLUDEDIR)GenNodeEdgemap.hpp
ALLFILESO +=		$(BUILDDIR)main.o $(BUILDDIR)Types.o 		$(BUILDDIR)GraphProperties.o		$(BUILDDIR)ReadFile.o		$(BUILDDIR)CheckFile.o 		$(BUILDDIR)SimplifyGraph.o		$(BUILDDIR)DegreeCentrality.o		$(BUILDDIR)GenAlters.o  	$(BUILDDIR)PrestigeSimple.o		$(BUILDDIR)AdjacencyMatrix.o 		$(BUILDDIR)DisconnectedSubgraphs.o		# $(BUILDDIR)EigenLibraryTest.o		$(BUILDDIR)GenNodelist.o					$(BUILDDIR)TriadGen.o		$(BUILDDIR)GenCliques.o		$(BUILDDIR)GenEdgemap.o		$(BUILDDIR)GenNodeEdgemap.o
...
$(BUILDDIR)AdjacencyMatrix.o: $(INCLUDEDIR)AdjacencyMatrix.hpp $(INCLUDEDIR)Types.hpp
	$(CXX) $(CXXFLAGS) -c $(INCLUDEDIR)AdjacencyMatrix.hpp -o $(BUILDDIR)AdjacencyMatrix.o

$(BUILDDIR)DisconnectedSubgraphs.o: $(INCLUDEDIR)DisconnectedSubgraphs.hpp $(INCLUDEDIR)Types.hpp
	$(CXX) $(CXXFLAGS) -c $(INCLUDEDIR)DisconnectedSubgraphs.hpp -o $(BUILDDIR)DisconnectedSubgraphs.o

#$(BUILDDIR)EigenLibraryTest.o: $(INCLUDEDIR)EigenLibraryTest.hpp
#	$(CXX) $(CXXFLAGS) -c $(INCLUDEDIR)EigenLibraryTest.hpp -o $(BUILDDIR)EigenLibraryTest.o
