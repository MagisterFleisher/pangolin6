...
Edgelist Read_Edgelist_CSV(const std::string& file_name, const int& skip_lines, const std::uint8_t& base) {
    Edgelist            edges;
...
Nodelist Read_Nodelist_CSV(const std::string& file_name, const int& skip_lines, const std::uint8_t& base) {
    Nodelist            nodes;
...
Graph Gen_Graph_Lists_CSV(const std::string& file_name, const int& skip_lines, const std::uint8_t& base) {
    Graph g;
...
Graph Gen_Graph_Edgelist(const std::string& file_name, const int& skip_lines, const std::uint8_t& base) {
    Graph g;
    g.edges = Read_Edgelist_CSV(file_name, skip_lines, base);
    g.magnitude = FindMagnitude(g.edges.size());
    return g; }
...
Graph Graph_Read(FileFormat format, const std::string& file_name, const int& skip_lines, const std::uint8_t& base) {
    Graph graph;
